        ...
        <div className="absolute md:top-40 md:left-0 z-10 -left-12">
          ...
          {backgroundImage.mobile && (
            <Image 
              ...
              className={`block rotate-20 sm:rotate-0 md:hidden ${backgroundImage.className || ''}`}
            />
          )}
        </div>
      )}
      ...
      <div className='justify-between items-center relative z-20 flex flex-col md:flex-row'>
        ...
        <div className="mt-12 md:mt-0">
          <img
            src={image.src}
            alt={image.alt}
            className={image.className ?? "w-full sm:w-[500px] sm:h-[267px] md:w-[550px] md:h-[367px] lg:w-[685px] lg:h-[456px] object-cover"}
          />
        </div>
      </div>
    </div>
